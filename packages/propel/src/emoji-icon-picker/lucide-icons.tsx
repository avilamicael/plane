...
export const LUCIDE_ICONS_LIST = [
  { name: t("activity"), element: Activity },
  ...
  { name: t("archive"), element: Archive },
  ...
  { name: t("issue.layouts.calendar"), element: Calendar },
  ...
  { name: t("editor_ui.blocks.code"), element: Code },
  ...
  { name: t("common.actions.delete"), element: Delete },
  ...
  { name: t("admin.header.segments.github"), element: Github },
  { name: t("admin.header.segments.gitlab"), element: Gitlab },
  ...
  { name: t("home.title"), element: Home },
  { name: t("admin.header.segments.image"), element: Image },
  { name: t("sidebar.inbox"), element: Inbox },
  { name: t("info"), element: Info },
  { name: "Instagram", element: Instagram },
  { name: t("editor_ui.marks.italic"), element: Italic },
  { name: "Key", element: Key },
  { name: "Layers", element: Layers },
  { name: t("common.layout"), element: Layout },
  { name: "LifeBuoy", element: LifeBuoy },
  { name: t("common.link"), element: Link },
  { name: "Link2", element: Link2 },
  { name: "Linkedin", element: Linkedin },
  { name: t("issue.layouts.list"), element: List },
  { name: "Loader", element: Loader },
  { name: t("page_editor.lock_control.lock"), element: Lock },
  ...
  { name: t("search"), element: Search },
  { name: "ToggleLeft", element: ToggleLeft },
  { name: t("common.user"), element: User },
