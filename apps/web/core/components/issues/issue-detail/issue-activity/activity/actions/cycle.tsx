    ...
    >
      <>
        {activity.verb === "created" ? (
          <>
            <span>{t("issue.activity.added_this_work_item_to_the_cycle")} </span>
            <a
          ...
          <>
            <span>{t("issue.activity.set_the_cycle_to")} </span>
            <a
              href={`/${activity.workspace_detail?.slug}/projects/${activity.project}/cycles/${activity.new_identifier}`}
              target="_blank"
              rel="noopener noreferrer"
          ...
          <>
            <span>{t("issue.activity.removed_the_work_item_from_the_cycle")} </span>
            <a
