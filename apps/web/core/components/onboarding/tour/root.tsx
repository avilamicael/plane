...
const TOUR_STEPS: {
  ...
  {
    key: "work-items",
    i18n_title: "onboarding.tour.steps.work_items.title",
    i18n_description: "onboarding.tour.steps.work_items.description",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
    key: "cycles",
    i18n_title: "onboarding.tour.steps.cycles.title",
    i18n_description: "onboarding.tour.steps.cycles.description",
    image: CyclesTour,
    prevStep: "work-items",
    nextStep: "modules",
  },
  {
    key: "modules",
    i18n_title: "onboarding.tour.steps.modules.title",
    i18n_description: "onboarding.tour.steps.modules.description",
    image: ModulesTour,
    prevStep: "cycles",
    nextStep: "views",
  },
  {
    key: "views",
    i18n_title: "onboarding.tour.steps.views.title",
    i18n_description: "onboarding.tour.steps.views.description",
    image: ViewsTour,
    prevStep: "modules",
    nextStep: "pages",
  },
  {
    key: "pages",
    i18n_title: "onboarding.tour.steps.pages.title",
    i18n_description: "onboarding.tour.steps.pages.description",
    image: PagesTour,
    prevStep: "views",
  },
];
...
export const TourRoot = observer(function TourRoot(props: TOnboardingTourProps) {
  ...
  const currentStepTitle = currentStep ? t(currentStep.i18n_title) : "";
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              ...
              <div className="flex h-full items-end">
                <div className="mt-12 flex items-center gap-6">
                  ...
                  >
                    {t("onboarding.tour.welcome.take_tour")}
                  </Button>
                  <button
                    type="button"
