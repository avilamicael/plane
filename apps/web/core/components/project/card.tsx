...
export const ProjectCard = observer(function ProjectCard(props: Props) {
  ...
  const handleAddToFavorites = () => {
    ...
    setPromiseToast(addToFavoritePromise, {
      ...
      error: {
        ...
        message: () => t("common.project_favorite.add_failed"),
      },
    });
  };
  ...
  const handleRemoveFromFavorites = () => {
    ...
    setPromiseToast(removeFromFavoritePromise, {
      ...
      error: {
        title: t("common.toast.error"),
        message: () => t("common.project_favorite.remove_failed"),
      },
    });
  };
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              >
                {projectMembersIds && projectMembersIds.length > 0 ? (
                  ...
                  <span className="text-13 text-placeholder italic">{t("project.card.no_members_yet")}</span>
                )}
              </Tooltip>
              {isArchived && <div className="text-11 font-medium text-placeholder">{t("common.archived")}</div>}
            </div>
            {isArchived ? (
              hasAdminRole && (
                <div className="flex items-center justify-center gap-2">
