    ...
    await createModule(workspaceSlug.toString(), selectedProjectId, payload)
      .then((_res) => {
        ...
        setToast({
          ...
          message: t("module.toasts.create.success.message"),
        });
      })
      .catch((err) => {
        setToast({
          ...
          message: err?.detail ?? err?.error ?? t("module.toasts.create.error.message"),
        });
      });
  };
    ...
    await updateModuleDetails(workspaceSlug.toString(), selectedProjectId, data.id, payload)
      ...
      .catch((err) => {
        setToast({
          type: TOAST_TYPE.ERROR,
          title: t("common.toast.error"),
          message: err?.detail ?? err?.error ?? t("module.toasts.update.error.message"),
        });
      });
  };
