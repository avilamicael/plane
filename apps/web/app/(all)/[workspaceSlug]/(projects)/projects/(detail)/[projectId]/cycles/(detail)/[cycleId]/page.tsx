  ...
  return (
    <>
      ...
      {!cycle && !loader ? (
        <EmptyState
          image={emptyCycle}
          title={t("project_empty_state.invalid_cycle.title")}
          description={t("project_empty_state.invalid_cycle.description")}
          primaryButton={{
            text: t("project_empty_state.invalid_cycle.cta_primary"),
