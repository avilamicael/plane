  ...
  return (
    <>
      ...
      {error ? (
        <EmptyState
          image={emptyModule}
          title={t("project_empty_state.invalid_module.title")}
          description={t("project_empty_state.invalid_module.description")}
          primaryButton={{
            text: t("project_empty_state.invalid_module.cta_primary"),
