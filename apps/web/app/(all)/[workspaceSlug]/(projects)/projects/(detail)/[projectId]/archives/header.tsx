...
const PROJECT_ARCHIVES_BREADCRUMB_LIST: {
  ...
  issues: {
    i18n_label: "common.work_items",
    href: "/issues",
    icon: WorkItemsIcon,
  },
  cycles: {
    i18n_label: "common.cycles",
    href: "/cycles",
    icon: CycleIcon,
  },
  modules: {
    i18n_label: "common.modules",
    href: "/modules",
    icon: ModuleIcon,
  },
};
      ...
      <Header.LeftItem>
        <div className="flex items-center gap-2.5">
          <Breadcrumbs onBack={router.back} isLoading={loader === "init-loader"}>
            ...
            {activeTabBreadcrumbDetail && (
              <Breadcrumbs.Item
                component={
                  <BreadcrumbLink
                    label={t(activeTabBreadcrumbDetail.i18n_label)}
          ...
          {activeTab === "issues" && issueCount && issueCount > 0 ? (
            <Tooltip
              isMobile={isMobile}
              tooltipContent={t("common.work_items_in_archives_count", { count: issueCount })}
              position="bottom"
            >
