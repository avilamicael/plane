      ...
      <div className="flex h-full w-full flex-col items-center justify-center px-3">
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            >
              <EmptySpaceItem Icon={CheckIcon} title={t("workspace_invitation.actions.accept")} action={handleAccept} />
              <EmptySpaceItem Icon={CloseIcon} title={t("workspace_invitation.actions.ignore")} action={handleReject} />
            </EmptySpace>
          )
          ...
          invitationDetail?.accepted ? (
            <EmptySpace
              ...
              description={t("workspace_invitation.description")}
            >
              <EmptySpaceItem Icon={Boxes} title={t("workspace_invitation.actions.continue_to_home")} href="/" />
            </EmptySpace>
          ) : (
            <EmptySpace
              title={t("workspace_invitation.inactive_title")}
              description={t("workspace_invitation.description")}
              link={{ text: t("workspace_invitation.start_from_empty_project"), href: "/" }}
            >
              {!currentUser ? (
                <EmptySpaceItem Icon={User2} title={t("workspace_invitation.actions.sign_in_to_continue")} href="/" />
              ) : (
                <EmptySpaceItem Icon={Boxes} title={t("workspace_invitation.actions.continue_to_home")} href="/" />
              )}
              ...
              <EmptySpaceItem
                Icon={Share2}
                title={t("workspace_invitation.actions.join_community")}
