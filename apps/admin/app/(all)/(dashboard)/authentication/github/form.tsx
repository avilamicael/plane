...
export function InstanceGithubConfigForm(props: Props) {
  ...
  const GITHUB_FORM_FIELDS: TControllerInputFormField<GithubConfigFormValues>[] = [
    ...
    },
    {
      ...
      type: "text",
      label: t("admin.oauth.organization_id"),
      description: <>{t("admin.oauth.organization_id_description")}</>,
  ...
  const GITHUB_COMMON_SERVICE_DETAILS: TCopyField[] = [
    {
      key: "Origin_URL",
      label: t("admin.oauth.origin_url"),
      url: originURL,
      description: (
        <>
          {t("admin.oauth.autogenerated_paste_origin")}{" "}
          <CodeBlock darkerShade>{t("admin.oauth.authorized_origin_url")}</CodeBlock> {t("admin.oauth.field_word")}{" "}
          <a
            href="https://github.com/settings/applications/new"
            target="_blank"
            className="text-accent-primary hover:underline"
