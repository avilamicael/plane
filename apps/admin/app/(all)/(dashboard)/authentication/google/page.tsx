  ...
  const updateConfig = async (key: "IS_GOOGLE_ENABLED", value: string) => {
    ...
    setPromiseToast(updateConfigPromise, {
      ...
      success: {
        ...
        message: () =>
          value === "1"
            ? t("admin.oauth.auth_now_active", { provider: t("admin.header.segments.google") })
            : t("admin.oauth.auth_now_disabled", { provider: t("admin.header.segments.google") }),
      },
      error: {
...
export const meta: Route.MetaFunction = () => [{ title: i18nInstance.t("admin.page_titles.auth_google") }];
