  ...
  const GOOGLE_FORM_FIELDS: TControllerInputFormField<GoogleConfigFormValues>[] = [
    {
      ...
      description: (
        <>
          {t("admin.oauth.google_client_id_description")}{" "}
          <a
            href="https://developers.google.com/identity/protocols/oauth2/javascript-implicit-flow#creatingcred"
            target="_blank"
            className="text-accent-primary hover:underline"
            rel="noreferrer"
            aria-label={t("admin.oauth.google_client_id_description")}
          >
    ...
    },
    {
      ...
      description: (
        <>
          {t("admin.oauth.google_client_secret_description")}{" "}
          <a
            href="https://developers.google.com/identity/oauth2/web/guides/get-google-api-clientid"
            target="_blank"
            className="text-accent-primary hover:underline"
            rel="noreferrer"
            aria-label={t("admin.oauth.google_client_secret_description")}
          >
            {t("admin.common.learn_more")}
          </a>
        </>
  ...
  const GOOGLE_COMMON_SERVICE_DETAILS: TCopyField[] = [
    {
      ...
      description: (
        <p>
          ...
          <CodeBlock darkerShade>{t("admin.oauth.authorized_js_origins")}</CodeBlock>{" "}
          {t("admin.oauth.for_this_oauth_client")}{" "}
          <a
  ...
  const GOOGLE_SERVICE_DETAILS: TCopyField[] = [
    {
      ...
      description: (
        <p>
          {t("admin.oauth.autogenerated_paste_callback")}{" "}
          <CodeBlock darkerShade>{t("admin.oauth.authorized_redirect_uri")}</CodeBlock>{" "}
          {t("admin.oauth.for_this_oauth_client")}{" "}
          <a
            href="https://console.cloud.google.com/apis/credentials/oauthclient"
            target="_blank"
